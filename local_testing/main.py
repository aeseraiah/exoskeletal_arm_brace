...
create_duration_amplitude_file.create_duration_file(coolterm_filename='./data/coolterm_samplingrate_900Hz.txt', new_filename='amplitude_and_durations_900Hz')
...
interpolate.interp(amplitude_and_durations_filename='amplitude_and_durations_900Hz.csv', interp_filename='fake_interpolation_data')
# 'interp_filename' file will be located in 'local_testing/collection_data/interpolation'

### 3: 
label_data.data_labeling(interpolated_filename='./collection_data/interpolation/fake_interpolation_data.csv', labeled_filename='amplitude_and_durations_900Hz_labeled')
